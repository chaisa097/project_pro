...
<div class="d-flex">
    <div class="text-center m-auto nav-top-logo header-color">
        <a href="{{route('index','home')}}">
          <img class="icon-destop" src="{{ asset('front-ends-assets/images/logo.png')}}" >
        </a>
    </div>
    <div class="left-content header-color"> 
            <div class="pr-5  mt-1">
            <div>
     ...
     <div class="gra-dian-bor"></div>
    <nav class="navbar navbar-expand-md navbar-dark bg-color sidebarNavigation" data-sidebarClass="navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <li class="nav-item {{$seo->slug == 'home'?'active':''}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="http://www.jetsadabet.com/register/jetsadapro"><span class="text-upderline">สมัครสมาชิก</span></a>
                    </li>
...
<div id="mySidenav" class="sidenav">
        ...
        <a href="http://www.jetsadabet.com/register/jetsadapro">สมัครสมาชิก</a>
